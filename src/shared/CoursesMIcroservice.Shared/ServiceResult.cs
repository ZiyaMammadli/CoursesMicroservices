...
namespace CoursesMicroservice.Shared
{
    public class ServiceResult
    {
        ...
        public static ServiceResult ErrorFromValidator(IDictionary<string, object?> errors)
        {
            return new ServiceResult
            {
    ...
    public class ServiceResult<T> : ServiceResult
    {
        ...
        public new static ServiceResult<T> ErrorFromValidator(IDictionary<string, object?> errors)
        {
            return new ServiceResult<T>
            {
                Status = HttpStatusCode.BadRequest,
